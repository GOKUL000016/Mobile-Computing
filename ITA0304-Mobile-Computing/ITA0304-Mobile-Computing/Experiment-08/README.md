# Experiment 08 – Public Land Mobile Network (PLMN)

## Aim
To create an infographic in Figma explaining the concept of Public Land Mobile Network (PLMN).
...
## Design
An infographic detailing PLMN components and operation.
