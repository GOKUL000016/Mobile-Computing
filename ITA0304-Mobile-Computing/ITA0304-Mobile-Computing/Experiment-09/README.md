# Experiment 09 – GSM Service

## Aim
To develop a user interface prototype for a GSM service using Figma.
...
## Design
UI prototype for a service operating over GSM.

## Prototype
User flows showcasing the GSM service.
